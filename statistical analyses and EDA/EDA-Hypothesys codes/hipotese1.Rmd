...
## Olhando os dez estados com os maiores volumes de observações para sedãs automáticos de 4 portas da Chevrolet:
```{r table}
...
## Calculando a média dos preços dos sedãs automáticos de 4 portas da Chevrolet para os estados com os maiores volumes de observações:
...
## Fazendo um gráfico boxplot dos preços em relação aos estados com maiores volumes de observações:
```{r box}
