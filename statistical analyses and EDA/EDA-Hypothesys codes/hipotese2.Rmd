...
# Filtrando apenas os cinco estados com os maiores números de carros com IPVA pago
```{r table2}
...
# Criando um boxplot dos preços dos cinco estados com os maiores números de carros com IPVA pago cujos vendedores sejam pessoa física:
```{r table3}
