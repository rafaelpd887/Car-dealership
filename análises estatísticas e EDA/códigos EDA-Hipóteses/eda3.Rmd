...
## Calculando o volume de observações em cada "estado_vendedor"
```{r vendas}
...
#### Mais uma vez, o estado de São Paulo demonstra, de forma geral, as métricas mais interessantes para o objetivo em questão. Além de possuir o maior volume de observações, São Paulo também apresenta um dos carros com garantia com um dos menores preços.
...
#### Essas métricas indicam que, com base nos dados analisados, São Paulo é o estado mais propício para a compra de carros com garantia de fábrica. É onde encontraríamos o maior número de opções disponíveis, além de possuir um preço médio razoável. Além disso, o grande número de observações e o desvio padrão de amplitude razoável indicam que o comprador teria boas chances de encontrar oportunidades a preços baixos, desde que estivesse disposto a procurá-las.
